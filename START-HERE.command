...
# ---------- 4. Do the work ----------
echo "----------------------------------------------"
echo "Step 1 of 5: pushing the backlogs to semester-docs"
echo "----------------------------------------------"
./import/push-docs.sh || { echo "Failed. Copy the error above and send it to Claude."; read -r -p "Press Return to close. "; exit 1; }

echo
echo "----------------------------------------------"
echo "Step 2 of 5: creating labels"
echo "----------------------------------------------"
./import/bootstrap-labels.sh

echo
echo "----------------------------------------------"
echo "Step 3 of 5: creating Sprint 1 to 7 milestones"
echo "----------------------------------------------"
./import/create-milestones.sh

echo
echo "----------------------------------------------"
echo "Step 4 of 5: creating 103 issues"
echo "This is the slow part. Roughly five minutes."
echo "----------------------------------------------"
./import/create-issues.sh

echo
echo "----------------------------------------------"
echo "Step 5 of 5: building the four Project boards"
