...
| **Blocked** | An item that cannot be completed until Metro answers a question. Twenty-three items across the four products are in this state, down from thirty-five before Metro's August answers. |
